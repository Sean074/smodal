...
3) Feels like the user should be able to pick mode freqs in the CMIF plot and these added to the stability diagram table fitting process.
7) is the fitting limited the selected freq range?
8) the page 4 plots should scale to the selected freq range
